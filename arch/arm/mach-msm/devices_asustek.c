...
static struct resource pdata_resources_leopardcat[] = {
	{
		.start	= PM8921_GPIO_PM_TO_SYS(6),
		.end	= PM8921_GPIO_PM_TO_SYS(6),
		.name	= "PCB_ID12",
		.flags	= IORESOURCE_IO,
	},
	{
...
struct asustek_pcbid_platform_data asustek_pcbid_pdata = {
	.UUID = serialno,
	.resource_leopardcat = pdata_resources_leopardcat,
	.nr_resource_leopardcat = ARRAY_SIZE(pdata_resources_leopardcat),
};
