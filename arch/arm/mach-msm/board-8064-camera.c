...
#ifdef ASUS_LEOPARDCAT
static struct camera_vreg_t apq_8064_hm2056_vreg[] = {
};

static struct msm_camera_csi_lane_params hm2056_csi_lane_params = {
	.csi_lane_assign = 0xE4,
	.csi_lane_mask = 0x3,
};
...
static struct msm_camera_sensor_platform_info sensor_board_info_hm2056 = {
	.mount_angle	= 0,
	.cam_vreg = apq_8064_hm2056_vreg,
	.num_vreg = ARRAY_SIZE(apq_8064_hm2056_vreg),
	.gpio_conf = &apq8064_back_cam_gpio_conf,
	.i2c_conf = &apq8064_back_cam_i2c_conf,
	.csi_lane_params = &hm2056_csi_lane_params,
};
...
static struct camera_vreg_t apq_8064_gc0310_vreg[] = {
};

static struct msm_camera_csi_lane_params gc0310_csi_lane_params = {
	.csi_lane_assign = 0xE4,
	.csi_lane_mask = 0x03, //0x1,
};

static struct msm_camera_sensor_flash_data flash_gc0310 = {
	.flash_type	= MSM_CAMERA_FLASH_NONE,
};

static struct msm_camera_sensor_platform_info sensor_board_info_gc0310 = {
	.mount_angle	= 0,
	.cam_vreg = apq_8064_gc0310_vreg,
	.num_vreg = ARRAY_SIZE(apq_8064_gc0310_vreg),
	.gpio_conf = &apq8064_front_cam_gpio_conf,
	.i2c_conf = &apq8064_front_cam_i2c_conf,
	.csi_lane_params = &gc0310_csi_lane_params,
};

static struct msm_camera_sensor_info msm_camera_sensor_gc0310_data = {
	.sensor_name	= "gc0310",
	.pdata	= &msm_camera_csi_device_data[1],
	.flash_data	= &flash_gc0310,
	.sensor_platform_info = &sensor_board_info_gc0310,
	.csi_if	= 1,
	.camera_type = FRONT_CAMERA_2D,
	.sensor_type = BAYER_SENSOR,
	//.vendor_name = "A",
...
void __init apq8064_init_cam(void)
{
	...
	if (socinfo_get_platform_subtype() != PLATFORM_SUBTYPE_SGLTE2) {
		...
		printk("%s: platform_subtype is %d\n", __func__, socinfo_get_platform_subtype());
	}
...
static struct i2c_board_info apq8064_camera_i2c_boardinfo[] = {
	...
	.platform_data = &msm_camera_sensor_gc0310_data,
	},
#else
	{
