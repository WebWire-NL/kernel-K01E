...
void __init apq8064_init_mmc(void)
{
	if (apq8064_sdc1_pdata) {
		...
		if(machine_is_apq8064_leopardcat()) {
			apq8064_sdc1_pdata->pin_data->pad_data->drv->on[1].val = GPIO_CFG_6MA;
			apq8064_sdc1_pdata->pin_data->pad_data->drv->on[2].val = GPIO_CFG_6MA;
			apq8064_sdc1_pdata->pin_data->pad_data->drv->off[1].val = GPIO_CFG_6MA;
			apq8064_sdc1_pdata->pin_data->pad_data->drv->off[2].val = GPIO_CFG_6MA;
		}
