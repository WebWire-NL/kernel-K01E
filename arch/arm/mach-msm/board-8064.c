...
static void __init apq8064_reserve(void)
{
	apq8064_set_display_params(prim_panel_name, ext_panel_name,
		ext_resolution);
	msm_reserve();
	if (machine_is_apq8064_mtp() || machine_is_apq8064_macaque() ||
		machine_is_apq8064_leopardcat())
		asustek_reserve();
}
...
static void __init apq8064_ehci_host_init(void)
{
	if (machine_is_apq8064_liquid() || machine_is_mpq8064_cdp() ||
		...
		machine_is_apq8064_mtp() || machine_is_apq8064_macaque()) {
#if 0
...
static struct i2c_board_info UPI_bat_device_info[] = {
        {
...
static void bq27541_gauge_init(void)
{
...
static void upi_gauge_init(void)
{
        i2c_register_board_info(APQ_8064_GSBI1_QUP_I2C_BUS_ID,
        UPI_bat_device_info,
        ARRAY_SIZE(UPI_bat_device_info));
}
...
static struct i2c_board_info i2c_asusdec_info[] __initdata = {
	{
...
static struct touch_platform_data himax_touch_pdata[] = {
	{
		.hx_rx_num = 32,
		.hx_tx_num = 50,
		.hx_x_res = 1920,
...
static struct i2c_board_info himax_i2c_info[] __initdata = {
	{
		I2C_BOARD_INFO("himax-ts", 0x48),
		.platform_data = &himax_touch_pdata,
	},
};

static struct i2c_board_info NVT_i2c_info[] __initdata = {
	{
...
#define GPIO_KEY_VOLUME_UP_PM8921	PM8921_GPIO_PM_TO_SYS(4)
...
static struct gpio_keys_button asustek_keys[] = {
	...
	{
		.code           = KEY_VOLUMEUP,
		.gpio           = GPIO_KEY_VOLUME_UP_PM8921,
		.desc           = "volume_up_key",
		.active_low     = 1,
		.type		= EV_KEY,
		.wakeup		= 1,
...
static struct gpio_keys_platform_data asustek_keys_data = {
	.buttons        = asustek_keys,
	.nbuttons       = ARRAY_SIZE(asustek_keys),
};

static struct platform_device asustek_kp_pdev = {
	.name           = "gpio-keys",
	.id             = -1,
	.dev            = {
		.platform_data  = &asustek_keys_data,
	},
};
...
static struct i2c_board_info rt5888_backlight_i2c_info[] = {
	{
		I2C_BOARD_INFO("rt8555", 0x31),
	},
};
...
static struct i2c_registry himax_i2c_devices __initdata = {
	I2C_FFA,
	APQ_8064_GSBI3_QUP_I2C_BUS_ID,
	himax_i2c_info,
	ARRAY_SIZE(himax_i2c_info),
};

static struct i2c_registry nvt_i2c_devices __initdata = {
	I2C_FFA,
	APQ_8064_GSBI3_QUP_I2C_BUS_ID,
	NVT_i2c_info,
	ARRAY_SIZE(NVT_i2c_info),
};

static struct i2c_registry asusdec_i2c_devices __initdata = {
	I2C_SURF | I2C_FFA | I2C_RUMI | I2C_SIM | I2C_LIQUID,
	APQ_8064_GSBI1_QUP_I2C_BUS_ID,
	i2c_asusdec_info,
	ARRAY_SIZE(i2c_asusdec_info),
};
...
static void __init register_i2c_devices(void)
{
	...
	if (machine_is_apq8064_cdp())
		mach_mask = I2C_SURF;
	else if (machine_is_apq8064_mtp() || machine_is_apq8064_macaque() ||
		machine_is_apq8064_leopardcat())
		mach_mask = I2C_FFA;
	...
	if (machine_is_apq8064_macaque()) {
		i2c_register_board_info(asusdec_i2c_devices.bus,
			asusdec_i2c_devices.info,
			asusdec_i2c_devices.len);
		i2c_register_board_info(himax_i2c_devices.bus,
			himax_i2c_devices.info,
			himax_i2c_devices.len);
	}

	if (machine_is_apq8064_leopardcat()) {
		i2c_register_board_info(nvt_i2c_devices.bus,
			nvt_i2c_devices.info,
			nvt_i2c_devices.len);
		i2c_register_board_info(himax_i2c_devices.bus,
			himax_i2c_devices.info,
			himax_i2c_devices.len);
...
static void __init apq8064_common_init(void)
{
	...
	msm_hsic_pdata.swfi_latency =
		msm_rpmrs_levels[0].latency_us;
	if ((machine_is_apq8064_mtp() || machine_is_apq8064_macaque()) && (0)) {
...
static void __init apq8064_cdp_init(void)
{
	...
	if (machine_is_apq8064_mtp() || machine_is_apq8064_macaque() ||
		machine_is_apq8064_leopardcat()) {
		platform_device_register(&asustek_kp_pdev);
...
MACHINE_START(APQ8064_MACAQUE, "QCT APQ8064 MACAQUE")
	.map_io = apq8064_map_io,
	.reserve = apq8064_reserve,
	.init_irq = apq8064_init_irq,
	.handle_irq = gic_handle_irq,
...
MACHINE_START(APQ8064_LEOPARDCAT, "QCT APQ8064 LEOPARDCAT")
	.map_io = apq8064_map_io,
	.reserve = apq8064_reserve,
	.init_irq = apq8064_init_irq,
	.handle_irq = gic_handle_irq,
