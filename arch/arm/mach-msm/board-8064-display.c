...
#define LEOPARDCAT_MSM_FB_PRIM_BUF_SIZE roundup(1280 * 800 * 4 * 3, 0x10000)
#else
/* prim = 1366 x 768 x 3(bpp) x 2(pages) */
#define MSM_FB_PRIM_BUF_SIZE roundup(1920 * 1200 * 4 * 2, 0x10000)
#define LEOPARDCAT_MSM_FB_PRIM_BUF_SIZE roundup(1280 * 800 * 4 * 2, 0x10000)
#endif

#define MSM_FB_SIZE roundup(MSM_FB_PRIM_BUF_SIZE, 4096)
#define LEOPARDCAT_MSM_FB_SIZE roundup(LEOPARDCAT_MSM_FB_PRIM_BUF_SIZE, 4096)
...
void __init apq8064_allocate_fb_region(void)
{
	...
	if (machine_is_apq8064_leopardcat()) {
		printk("Usiing leopardcat buffer size.\n");
		size = LEOPARDCAT_MSM_FB_SIZE;
	} else {
		size = MSM_FB_SIZE;
	}
...
{
	static struct regulator *reg_lvs7, *reg_l2, *reg_l17;
	int rc;
...
void __init apq8064_init_fb(void)
{
	...
	if (machine_is_apq8064_leopardcat()) {
		...
		printk("Macaque device, register mipi_auo_panel_device.\n");
