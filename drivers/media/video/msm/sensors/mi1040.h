...
static struct msm_camera_i2c_reg_conf mi1040_groupon_settings[] = {
	{0x0016, 0x1, MSM_CAMERA_I2C_UNSET_WORD_MASK,
		MSM_CAMERA_I2C_CMD_WRITE},
	{0x301A, 0x8000, MSM_CAMERA_I2C_SET_WORD_MASK,
		MSM_CAMERA_I2C_CMD_WRITE},
};

static struct msm_camera_i2c_reg_conf mi1040_groupoff_settings[] = {
	{0x0016, 0x1, MSM_CAMERA_I2C_UNSET_WORD_MASK,
		MSM_CAMERA_I2C_CMD_WRITE},
	{0x301A, 0x8000, MSM_CAMERA_I2C_UNSET_WORD_MASK,
		MSM_CAMERA_I2C_CMD_WRITE},
};
...
static struct msm_camera_i2c_reg_conf mi1040_raw_960p_recommend_settings_0[] = {
	// [Errata item 2]
	{0x301A, 0x0234, MSM_CAMERA_I2C_SET_WORD_MASK},
	// [Step2-PLL_Timing]
	// [PLL_settings]
...
static struct msm_camera_i2c_reg_conf mi1040_raw_960p_recommend_settings_1[] = {
	// [Step3-Recommended]
	// [Sensor optimization]
	{0x316A, 0x8270,},
	{0x316C, 0x8270,},
