...
static struct msm_camera_i2c_conf_array mi1040_raw_init_conf[] = {
	{mi1040_raw_960p_recommend_settings_0,
	ARRAY_SIZE(mi1040_raw_960p_recommend_settings_0), 0, MSM_CAMERA_I2C_WORD_DATA},
	{mi1040_config_change_settings,
	ARRAY_SIZE(mi1040_config_change_settings),
	0, MSM_CAMERA_I2C_WORD_DATA},
};
...
static struct msm_camera_i2c_conf_array mi1040_confs[] = {
	{mi1040_raw_960p_recommend_settings_1,
	ARRAY_SIZE(mi1040_raw_960p_recommend_settings_1), 0, MSM_CAMERA_I2C_WORD_DATA},
...
static struct msm_sensor_reg_t mi1040_regs = {
	...
	.group_hold_off_conf_size =
		ARRAY_SIZE(mi1040_groupoff_settings),
	.init_settings = &mi1040_raw_init_conf[0],
	.init_size = ARRAY_SIZE(mi1040_raw_init_conf),
