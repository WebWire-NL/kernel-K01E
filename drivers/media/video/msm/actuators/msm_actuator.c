	...
	struct msm_actuator_move_params_t *move_params)
{
	...
	if((a_ctrl->curr_step_pos > move_params->dest_step_pos &&
			a_ctrl->curr_step_pos - 4 > move_params->dest_step_pos) ||
			(move_params->dest_step_pos > a_ctrl->curr_step_pos &&
			move_params->dest_step_pos - 4 > a_ctrl->curr_step_pos))
		sw_damping_delay = 60000;
	else
		sw_damping_delay = 30000;
